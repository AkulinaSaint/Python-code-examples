...
# Например:
# Пупкин василий - неверно указано имя, te$T@test.net - неверно
# указан email (спецсимвол, заглавная буква, .net), te_4_st@test.com - верно указан.
import re

pattern = '^[А-Я]'
pattern_email = r"[0-9a-z_]+@[0-9a-z]+\.(ru|org|com)"

name = input('Введите ваше имя: ')
if re.search(pattern, name):
    print('Вы ввели имя правильно!')
else:
    print('Вы ввели имя в неверном формате!')

surname = input('Введите вашу фамилию: ')
if re.search(pattern, surname):
    print('Вы ввели фамилию правильно!')
else:
    print('Вы ввели фамилию в неверном формате!')

email = input('Введите ваш email: ')
if re.match(pattern_email, email):
    print('Вы ввели email правильно!')
else:
    print('Вы ввели email в неверном формате!')
...
if re.search(pattern, some_str):
    print('Я нашел три точки!')
else:
    print('Этот текст очень скучный')